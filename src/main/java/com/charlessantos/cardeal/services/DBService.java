...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		PaymentInBill paymentBill = new PaymentInBill(null, StatusPayment.PENDING, order2,
				dateFormat.parse("20/10/2020 12:15"), null);
		...
		vehicleBrandRepo.saveAll(Arrays.asList(brand1, brand2, brand3, brand4, brand5, brand6, brand7, brand8, brand9,
				brand10, brand11, brand12, brand13, brand14, brand15, brand16));
		...
		Car vehicle1 = new Car(null, "OQE2200", vehicleModel16, 2013, 2013, "PRIME", "1.6", "16",
				VehicleDoorQuantity.FIVE_DOOR, VehicleColor.VERMELHO, VehicleFuelType.BIFUEL, 76000);
		Car vehicle2 = new Car(null, "OQE2200", vehicleModel17, 2013, 2013, "PRIME", "1.6", "16",
				VehicleDoorQuantity.TWO_DOOR, VehicleColor.AZUL, VehicleFuelType.BIFUEL, 76000);
		Car vehicle3 = new Car(null, "OQE2200", vehicleModel18, 2013, 2013, "PRIME", "1.6", "16",
				VehicleDoorQuantity.TWO_DOOR, VehicleColor.BRANCO, VehicleFuelType.BIFUEL, 76000);
		Car vehicle4 = new Car(null, "OQE2200", vehicleModel16, 2013, 2013, "PRIME", "1.6", "16",
				VehicleDoorQuantity.FIVE_DOOR, VehicleColor.PRETO, VehicleFuelType.BIFUEL, 76000);
